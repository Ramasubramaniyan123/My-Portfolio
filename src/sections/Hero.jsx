    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background dark:bg-slate-900">
      ...
      <div className="max-w-[1400px] mx-auto container-padding relative z-10">
        <div className="text-center">
          {/* Greeting */}
          <div className="mb-4">
            <span className="text-secondary dark:text-slate-400 font-semibold text-lg uppercase tracking-wider">Hello, I'm</span>
          </div>

          {/* Name */}
          <h1 className="font-bold mb-6 text-text-primary dark:text-slate-100" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
            Ramasubramaniyan K
          </h1>

          {/* Typing Animation */}
          <div className="mb-8">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-text-secondary dark:text-slate-300">
              I am <TypingEffect />
            </h2>
          </div>

          {/* Description */}
          <p className="text-lg md:text-xl text-text-secondary dark:text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex items-center justify-center space-x-8 mb-8">
            {socialLinks.map((social) => (
              <a
                ...
                className="text-text-secondary dark:text-slate-300 hover:text-primary transition-all duration-250 hover:scale-110 hover:rotate-[12deg]"
              >
                <social.icon size={28} />
              </a>
            ))}
          ...
          {/* Social Share */}
          <SocialShare 
            title="Ramasubramaniyan K - Java Developer Portfolio"
            description="Final-year Cybersecurity student passionate about Java, DSA, and building efficient backend systems."
          />
        </div>
      </div>
    </section>
